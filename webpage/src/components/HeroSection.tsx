        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center md:text-left order-2 md:order-1 flex flex-col items-center md:items-start">
            ...
            <div className="inline-block mb-4 sm:mb-6 lg:mb-8">
              <Badge className="bg-blue-600 border border-white text-white px-2.5 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 lg:px-5 lg:py-2.5 rounded-full shadow-sm text-xs sm:text-sm font-medium hover:bg-blue-600">
                <Sparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-4 md:h-4 mr-1 sm:mr-1.5 md:mr-2 lg:mr-2.5" />
