...
const HeroSection = ({ onScrollToPricing }: { onScrollToPricing: () => void }) => {
  const [isVideoOpen, setIsVideoOpen] = useState(false);

  const handleStartTrial = () => {
    window.location.href = "https://app.genfuze.ai";
  };
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button variant="premium" size="xl" className="group" onClick={() => setIsVideoOpen(true)}>
      ...
      {isVideoOpen && <VideoPlayer videoUrl="/videos/demo.mp4" onClose={() => setIsVideoOpen(false)} />}
    </section>
  );
};
