  ...
  const testimonials = [
    {
      ...
      avatar: "SC",
      content: "kabini AI transformed our content strategy completely. The semantic matching feature helped us identify gaps we never knew existed. Our organic traffic increased by 150% in just 3 months.",
      rating: 5
    },
    {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            See how leading brands are using kabini AI to revolutionize their content strategy 
