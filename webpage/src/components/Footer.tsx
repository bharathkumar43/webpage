...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-100 via-blue-50 to-slate-200 text-gray-800">
      <div className="container mx-auto px-4 pt-16 sm:pt-20 lg:pt-24 pb-8 sm:pb-12">
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://www.facebook.com/kabiniAI/" className="text-gray-500 hover:text-blue-600 transition-colors flex items-center justify-center w-6 h-6">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://x.com/KabiniAI" className="text-gray-500 hover:text-blue-600 transition-colors flex items-center justify-center w-6 h-6">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <a href="https://www.linkedin.com/company/kabini-ai/" className="text-gray-500 hover:text-blue-600 transition-colors flex items-center justify-center w-6 h-6">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
