...
import { Bot, Search, Eye, Zap, Brain, Target } from "lucide-react";
...
const FeaturesSection = forwardRef<HTMLDivElement>((props, ref) => {
  const features = [
    ...
    },
    {
      ...
      description: "Analyze your content's visibility across AI platforms and search engines. Get detailed insights on how AI systems perceive and rank your content for better discoverability.",
      badge: "AI Analysis"
    },
    {
      icon: Zap,
  ...
  return (
    <section ref={ref} id="features" className="py-20 bg-background relative">
