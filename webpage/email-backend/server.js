...
const EMAIL_CONFIG = {
  ...
  companyName: 'Genfuze.ai',           // Your company name
  senderName: 'Genfuze.ai Team',       // Sender name in emails
  senderEmail: process.env.FROM_EMAIL || 'noreply@genfuze.ai',
  websiteUrl: 'https://genfuze.ai',    // Your website URL
  supportEmail: 'support@genfuze.ai',  // Support email
  logoUrl: 'https://genfuze.ai/logo.png', // Your logo URL
